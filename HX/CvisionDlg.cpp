...
BEGIN_MESSAGE_MAP(CvisionDlg, CDialogEx)
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_VISION_BUTTON_LOG, &CvisionDlg::OnBnClickedVisionButtonLog)
	ON_BN_CLICKED(IDC_VISION_BUTTON_EXIT, &CvisionDlg::OnBnClickedVisionButtonExit)
	ON_WM_SIZE()
END_MESSAGE_MAP()
...
void CvisionDlg::OnBnClickedVisionButtonLog()
{
	// TODO: 在此添加控件通知处理程序代码
	CLoginDlg loginDlg;
	loginDlg.DoModal();
...
void CvisionDlg::OnBnClickedVisionButtonExit()
{
	// TODO: 在此添加控件通知处理程序代码
	LoginFlag = false;
